...
const phases = [
  ...
  },
  {
    num: 6,
    phase: 'Retraining',
    title: 'First Automated Pipeline Test',
    dates: 'Mar 1, 2026',
    icon: Cog,
  ...
  },
  {
    num: 8,
    phase: 'Retraining',
    title: 'Weekly Automated Retraining',
    dates: 'Mar 8, 2026',
    icon: Cog,
  ...
  },
  {
    num: 9,
    phase: 'Phase 5',
    title: 'Dashboard Migration to React',
  ...
  },
  {
    num: 10,
    phase: 'Retraining',
    title: 'Retraining on Expanded Data',
    dates: 'Mar 15, 2026',
    icon: Cog,
...
const techStack = [
  { name: 'Python 3.12', desc: 'Core language', icon: Brain },
  { name: 'React + Vite', desc: 'Frontend dashboard', icon: Atom },
  { name: 'FastAPI', desc: 'API server', icon: Server },
  { name: 'Scikit-Learn', desc: 'ML model training', icon: Cpu },
  { name: 'SQLite', desc: 'Persistent storage', icon: Database },
  { name: 'SHAP', desc: 'Explainability', icon: LineChart },
]
  ...
  return (
    <div className="p-8 max-w-[1000px] mx-auto">
        ...
        <div className="space-y-4">
          {phases.map((p) => {
            ...
            return (
              <div
                key={p.num}
                className={`relative animate-fade-in ${isCurrent ? 'gold-glow' : ''}`}
              >
                <div
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <PhaseIcon className="w-4 h-4 text-tejas-gold" />
                    <span
      ...
      <div className="flex items-center gap-2 mb-4">
        <Cpu className="w-4 h-4 text-tejas-gold" />
        <h3 className="text-sm font-semibold text-tejas-text">Technology Stack</h3>
      </div>
        ...
        {techStack.map((t) => {
          ...
          return (
            <div key={t.name} className="bg-tejas-card border border-tejas-border rounded-lg p-4 text-center card-hover">
              <TechIcon className="w-6 h-6 text-tejas-gold mx-auto" />
